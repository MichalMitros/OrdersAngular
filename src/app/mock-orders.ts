...
export const ORDERS: Order[] = [
  { id: 1, purchaser: 'Brisco', products: [PRODUCTS[0], PRODUCTS[2], PRODUCTS[4], PRODUCTS[5], PRODUCTS[9]] },
  { id: 2, purchaser: 'Bull Navigations', products: [PRODUCTS[4], PRODUCTS[6], PRODUCTS[9], PRODUCTS[5], PRODUCTS[2], PRODUCTS[0], PRODUCTS[7]] },
